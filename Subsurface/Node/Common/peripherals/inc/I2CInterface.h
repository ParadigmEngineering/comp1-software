...
class I2CInterface
{
    ...
    HAL_StatusTypeDef masterReceive(uint16_t address, uint32_t timeout);
    ...
    HAL_StatusTypeDef isDeviceReady(uint16_t devAddress, uint32_t timeout, uint32_t trials = 100);
